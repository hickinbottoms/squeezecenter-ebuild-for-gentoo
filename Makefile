...
inject: stage
	...
	$(SSH) "grep -q 'dev-perl/Package-Stash-XS ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/Package-Stash-XS ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/Module-Load ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/Module-Load ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-perl/Module-Load-Conditional ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/Module-Load-Conditional ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-Module-Load ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-Module-Load ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/Module-Load-Conditional ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/Module-Load-Conditional ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-Module-Load-Conditional ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-Module-Load-Conditional ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-perl/Perl-IPC-Cmd ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/Perl-IPC-Cmd ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/IPC-Cmd ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/IPC-Cmd ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-IPC-Cmd ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-IPC-Cmd ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-parent ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-parent ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-perl/Perl-XS-Loader ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/Perl-XS-Loader ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/XSLoader ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/XSLoader ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-XSLoader ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-XSLoader ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-perl/Module-Runtime ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/Module-Runtime ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/Params-Check ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/Params-Check ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-perl/Params-Classify ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/Params-Classify ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-perl/Package-Stash ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/Package-Stash ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-Params-Check ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-Params-Check ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/ExtUtils-MakeMaker ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/ExtUtils-MakeMaker ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-ExtUtils-MakeMaker ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-ExtUtils-MakeMaker ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-perl/EV ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-perl/EV ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-CPAN-Meta ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-CPAN-Meta ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-Parse-CPAN-Meta ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-Parse-CPAN-Meta ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/JSON-PP ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/JSON-PP ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-JSON-PP ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-JSON-PP ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-CPAN-Meta-YAML ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-CPAN-Meta-YAML ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/CPAN-Meta-YAML ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/CPAN-Meta-YAML ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'perl-core/CPAN-Meta ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'perl-core/CPAN-Meta ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'virtual/perl-Version-Requirements ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'virtual/perl-Version-Requirements ~x86' >> /etc/portage/package.keywords"
	$(SSH) "grep -q 'dev-lang/perl ' /etc/portage/package.keywords >/dev/null 2>&1 || echo 'dev-lang/perl ~x86' >> /etc/portage/package.keywords"
